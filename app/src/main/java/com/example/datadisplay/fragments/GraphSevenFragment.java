...
public class GraphSevenFragment extends Fragment {
    GraphView graphView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_graph_seven, container, false);
        graphView = rootView.findViewById(R.id.graphview7);
