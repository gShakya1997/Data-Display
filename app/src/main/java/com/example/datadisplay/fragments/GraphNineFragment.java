...
public class GraphNineFragment extends Fragment {
    GraphView graphView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_graph_nine, container, false);
        graphView = rootView.findViewById(R.id.graphview9);
